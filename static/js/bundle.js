...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserUpgrade = __webpack_require__(211);
	var BotDemo = __webpack_require__(226);
	...
	module.exports = React.createElement(
	  ...
	  React.createElement(
	    Route,
	    { path: '/', component: Main },
	    React.createElement(Route, { path: 'upgrade', component: UserUpgrade }),
	    React.createElement(Route, { path: 'demo', component: BotDemo }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialize = __webpack_require__(225);
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'form',
	        { onSubmit: this.getAvailPhoneNumbers },
	        ...
	        React.createElement(
	          ...
	          this.state.availPhoneNumbers.map(function (phoneNumber) {
	            ...
	            return React.createElement(
	              'div',
	              { key: number },
	              React.createElement('input', { type: 'radio', name: 'phone', value: number }),
	  ...
	  getAvailPhoneNumbers: function getAvailPhoneNumbers(evt) {
	    var _this = this;

	    evt.preventDefault();
	    var areacode = evt.target.querySelector('input').value;
	    axios.get('/phone/available/' + areacode).then(function (res) {
	      return _this.setState({ availPhoneNumbers: res.data });
	    });
	  },

	  buyPhoneNumber: function buyPhoneNumber(evt) {
	    var _this2 = this;

	    evt.preventDefault();
	    axios.post('/user/addphone', serialize(evt.target)).then(function () {
	      return _this2.history.pushState(null, '/');
	    });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
	  ...
	  submitMessage: function submitMessage(evt) {
	    var _this = this;
	    ...
	    axios.get('/bot?message=' + message).then(function (res) {
	      _this.setState({ messages: _this.state.messages.concat(res.data) });
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MenuItemListing = React.createClass({
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          null,
	          'Price: ',
	          (this.props.menuItem.price / 100).toFixed(2)
	        )
	      ),
	      React.createElement(
	        'button',
	  ...
	  renderMenuEdit: function renderMenuEdit() {
	    return React.createElement(
	      'form',
	      { key: this.props.menuItem._id, onSubmit: this.saveEdit },
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          ...
	          null,
	          'Name:',
	          React.createElement('input', { name: 'name', defaultValue: this.props.menuItem.name })
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Description:',
	          React.createElement('input', { name: 'description', defaultValue: this.props.menuItem.description })
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Price:',
	          React.createElement('input', { name: 'price', defaultValue: (this.props.menuItem.price / 100).toFixed(2) })
	        )
	      ),
	      React.createElement(
	        'button',
	  ...
	  deleteMenu: function deleteMenu() {
	    ...
	    axios.delete('/menu/delete/' + this.props.menuItem._id).then(function () {
	      _this.props.removeMenu(_this.props.menuItem);
	    });
	  },
	  saveEdit: function saveEdit(evt) {
	    ...
	    evt.preventDefault();
	    axios.put('/menu/update/' + this.props.menuItem._id, serialize(evt.target)).then(function (res) {
	      _this2.props.replaceMenu(_this2.props.menuItem, res.data);
	      _this2.setState({ errors: [] });
	    }).catch(function (res) {
	      _this2.setState({ errors: res.data });
	    });
	  },
	  toggleEditMode: function toggleEditMode(evt) {
	    evt.preventDefault();
	...
	module.exports = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    axios.get('/menu').then(function (res) {
	      _this3.setState({ menuItems: res.data });
	    });
	  },
	  render: function render() {
	    var _this4 = this;
	    ...
	    return React.createElement(
	      ...
	      this.state.menuItems.map(function (menuItem) {
	        return React.createElement(MenuItemListing, { menuItem: menuItem,
	          toggleEditMode: _this4.toggleEditMode,
	          removeMenu: _this4.removeMenu,
	          replaceMenu: _this4.replaceMenu });
	      })
	    );
	  },
	  renderNewMenuForm: function renderNewMenuForm() {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('br', null),
	        React.createElement('input', { name: 'price', placeholder: '0.00' }),
	        React.createElement('br', null),
	        React.createElement(
	          'button',
	          null,
	  ...
	  createMenuItem: function createMenuItem(evt) {
	    var _this5 = this;

	    evt.preventDefault();
	    axios.post('/menu/create', serialize(evt.target)).then(function (res) {
	      _this5.setState({
	        menuItems: _this5.state.menuItems.concat(res.data),
	        errors: {}
	      });
	      evt.target.reset();
	    }).catch(function (res) {
	      _this5.setState({ errors: res.data });
	    });
	  },
	  toggleEditMode: function toggleEditMode(menuItem) {
	    var idx = _.findIndex(this.state.menuItems, function (stateMenuItem) {
	      return stateMenuItem._id === menuItem._id;
	    });
	    var menuItems = update(this.state.menuItems, { $apply: function $apply(menuItems) {
	        menuItems[idx].editMode = !menuItems[idx].editMode;
	        return menuItems;
	      } });
	    this.setState({ menuItems: menuItems });
	  },
	  removeMenu: function removeMenu(menuItem) {
	    var menuItems = update(this.state.menuItems, { $apply: function $apply(menuItems) {
	        return _.without(menuItems, menuItem);
	      } });
	    this.setState({ menuItems: menuItems });
	  },
	  replaceMenu: function replaceMenu(menuItem, newMenuItem) {
	    var idx = _.findIndex(this.state.menuItems, function (stateMenuItem) {
	      return stateMenuItem._id === menuItem._id;
	    });
	    var menuItems = update(this.state.menuItems, { $apply: function $apply(menuItems) {
